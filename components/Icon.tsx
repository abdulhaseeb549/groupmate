...
const PATHS = {
  ...
  chat: 'M4.5 6A2.5 2.5 0 0 1 7 3.5h10A2.5 2.5 0 0 1 19.5 6v6a2.5 2.5 0 0 1-2.5 2.5h-6.5L7 18v-3.5a2.5 2.5 0 0 1-2.5-2.5z',
  image:
    'M4 7.5A2.5 2.5 0 0 1 6.5 5h11A2.5 2.5 0 0 1 20 7.5v9a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 16.5zM9.5 10.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0M4.5 16.2l4-3.7 3.5 3.2 3-2.4 4.5 3.7',
  audio: 'M3 10.5v3M6.75 8v8M10.5 5.5v13M14.25 8.5v7M18 10v4M21 11.2v1.6',
  send: 'M20.5 3.5 10 14M20.5 3.5l-6.6 17.2-3.9-6.7-6.7-3.9z',
  download: 'M12 4v11.5M7.5 11l4.5 4.5 4.5-4.5M5 17.5v1.5a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-1.5',
  video:
    'M3.5 8A2.5 2.5 0 0 1 6 5.5h6A2.5 2.5 0 0 1 14.5 8v8a2.5 2.5 0 0 1-2.5 2.5H6A2.5 2.5 0 0 1 3.5 16zM14.5 10.8l4.6-2.6a.6.6 0 0 1 .9.5v6.6a.6.6 0 0 1-.9.5l-4.6-2.6z',
  camera:
    'M4 8.5A2 2 0 0 1 6 6.5h2.2l.8-1.5a1 1 0 0 1 .9-.5h4.2a1 1 0 0 1 .9.5l.8 1.5H18a2 2 0 0 1 2 2V17a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2zM12 16a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4z',
} as const;
